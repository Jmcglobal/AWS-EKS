...
eksctl create iamserviceaccount \
    ...
    --namespace default \
    --cluster cluster \
    --attach-policy-arn arn:aws:iam::856671738330:policy/AllowExternalDNSUpdates \
    --approve \
    --override-existing-serviceaccounts
```
...
arn:aws:iam::856671738330:role/eksctl-cluster-addon-iamserviceaccount-defaul-Role1-0hwS3JXBCFIp
```
