...
# Template
#Note:  K8S Service Account Name that need  be bound to newly created IAM Role
eksctl create iamserviceaccount \
  --cluster=cluster \
  --namespace=kube-system \
  --name=aws-load-balancer-controller \
  --attach-policy-arn=arn:aws:iam::856671738330:policy/AWSLoadBalancerControllerIAMPolicy \
